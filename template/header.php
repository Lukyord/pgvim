...
<head>
    ...
    <link rel="mask-icon" href="<?php echo $root; ?>assets/img/favicon/safari-pinned-tab.svg" color="#0088ac">
    ...
    <link rel="stylesheet" href="<?php echo $root; ?>assets/css/about-history.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="<?php echo $root; ?>assets/css/learning-program.css?v=<?php echo time(); ?>">
            ...
            <div class="header-nav">
                ...
                <div class="header-logo">
                    <a href="<?php echo $root; ?>index.php" class="logo">
                        <img src="<?php echo $root; ?>assets/img/logo-with-text.png" alt="PGVIM Logo" draggable="false">
                    </a>
                </div>
                        ...
                        <div class="wrapper">
                                    ...
                                    <div class="panel-body">
                                        <ul class="menu size-button2">
                                            <li id="about-breadcrumb-trigger" class="breadcrumb-trigger">
                                                <p>
                                                    ABOUT US
                                                    <i class="ic ic-chevron-down size-icon-10 show-md"></i>
                                                    <i class="ic ic-chevron-right size-icon-10 hidden-device-md"></i>
                                                </p>
                                            </li>
                            ...
                            <div class="decoration hidden-device-md">
                                <div class="illustration var-2">
                                    <img src="./assets/img/design/illustration2.svg" alt="Illustration">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div class="breadcrumb-menu">
                                        <a href="javascript:;" class="breadcrumb-close hidden-device-md">
                                            <i class="ic ic-chevron-left size-icon-10"></i>
                                            ABOUT US
                                        </a>
                        ...
                        <div class="decoration hidden-device-md">
                            <div class="illustration var-1">
                                <img src="./assets/img/design/illustration1.svg" alt="Illustration">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="decoration hidden-device-md">
                            <div class="illustration var-4">
                                <img src="./assets/img/design/illustration4.svg" alt="Illustration">
                            </div>
                        </div>
                    </div>
                </div>
