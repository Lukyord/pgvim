                                ...
                                <div class="marquee-item">
                                    ...
                                    <div class="decoration">
                                        <div class="illustration var-<?php echo $var_num; ?>">
                                            <img src="./assets/img/design/illustration<?php echo $var_num; ?>.svg" alt="Illustration" loading="lazy" draggable="false">
                                        </div>
                                    </div>
                                </div>
                            <?php
                            ...
                            <!-- <div class="marquee-item">
                                ...
                                <div class="decoration">
                                    <div class="illustration var-5">
                                        <img src="./assets/img/design/illustration5.svg" alt="Illustration" draggable="false">
                                    </div>
                                </div>
                            </div> -->
                        </div>
            ...
            <div class="wrapper">
                ...
                $grid_gallery_arr = [
                    [
                        ...
                        "link" => "",
                        "image" => "./assets/img/design/index-news-image1.jpg",
                    ],
                    [
                        "type" => "RATCHABURI",
                        "date" => "1 - 4 NOV 2024",
                        ...
                        "link" => "",
                        "image" => "./assets/img/design/index-news-image2.jpg",
                    ],
                    [
                        ...
                        "image" => "./assets/img/design/index-news-image3.jpg",
                    ],
                    [
                        "type" => "LITTLE PRINCE",
                        "date" => "6 SEP 2024",
                        ...
                        "link" => "",
                        "image" => "./assets/img/design/index-news-image4.jpg",
                    ],
                    [
                        ...
                        "image" => "./assets/img/design/index-news-image5.jpg",
                    ],
                ];
